/*globals (window || this), document, XMLHttpRequest, ActiveXObject*/
(function(){
...
var exec = function(fn, module) {
    ...
    module.exports = {};
    fn.call((window || this), _req, module.exports, module, module.filename, module.dirname);
};
...
var MODULES = ((window || this).define && (window || this).define.modules) || {};
...
require.paths = [(window || this).location.pathname];
...
if ((window || this).require) {
    require.original = (window || this).require;
}
if ((window || this).define) {
    define.original = (window || this).define;
}

(window || this).require = require;
(window || this).define = define;
...
(window || this).addEventListener('DOMContentLoaded', function onload() {
    main_require(main);
}, false);
