...
module.exports = new Class({
	...
	loadCollection: function(name){
		...
		getExtensions(packageJson);
		console.log("[debug][Application.loadCollection] - Loading extensions for collection:", name, extensions);
	...
	_loadExtensions: function(extensions){
		...
		extensions.forEach(function(extension){
			try{
				...
				console.log("[debug][Application._loadExtensions] - loading extension", extension, packageJson);
				...
				console.log("[error][Application._loadExtensions] - error loading extension",
							extension, e);
				throw e;
			}
		});
		console.log("[debug][Application._loadExtensions] - completed loading extensions", Object.keys(self.activeExtensions));
	},
	_unloadAllExtensions: function(){
		var self = this;
		Object.each(self.activeExtensions, function(item, key){
			console.log("[debug][Application._unloadAllExtensions] - unloading extension:", key);
			item.unload();
