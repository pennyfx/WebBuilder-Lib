var Class = require('shipyard/class/Class'),
	...
	Control = require('builder-lib/control');
...
module.exports = new Class({
		...
		Accessors: {
			html: {
				...
				set: function(html){				
					this.element.node.innerHTML = html;
					return this;
				}
			}
		},
		...
		attachElement: function(){
			this.element = this.element || (this.options.element ? (this.options.element.element || this.options.element).set(this.options.attributes) : new DOM.Element(this.options.tag, this.options.attributes));
